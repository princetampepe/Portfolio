...
class App {
  ...
  update(time = 0) {
    const delta = this.lastFrameTime ? Math.min(time - this.lastFrameTime, 64) : 16.67;
    ...
    if (shouldAutoScroll) {
      this.scroll.target += this.autoScrollSpeed * (delta / 16.67);
    }
